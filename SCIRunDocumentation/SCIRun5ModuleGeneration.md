...
#### 5.6.1.[Building](Building)
#### 5.6.2 [Testing](Testing)

## 6 [Converting Modules from SCIRun4](Converting-Modules-from-SCIRun4)	
...
#### 6.1.4 [Get Module to Build Without Functionality](Get-Module-to-Build-Without-Functionality)
#### 6.1.5 [Add Module UI](Add-Module-UI)
#### 6.1.6 [Add Module Algorithm Files](Add-Module-Algorithm-Files)
#### 6.1.7 [Add Module and Algorithm Functionality](Add-Module-and-Algorithm-Functionality)
...
**Scope: [Strategy](Strategy) - [Common Function Changes](Common-Function-Changes) - [Common Build Errors](Common-Build-Errors)**
